...
export default function ResultadoJubilación({ route }) {
  ...
  const calcularJubilacion = () => {
    ...
    const montoFinal =
      montoActual * Math.pow(1 + tasaInteres / 100, tiempoRestante);
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.labelText}>
        Edad actual: <Text style={styles.resultText}>{edadActual} años</Text>
      </Text>
      <Text style={styles.labelText}>
        Edad de jubilación:{" "}
        <Text style={styles.resultText}>{edadJubilacion} años</Text>
      </Text>
      <Text style={styles.labelText}>
        Ahorros actuales: <Text style={styles.resultText}>{montoActual} </Text>
      </Text>
      <Text style={styles.labelText}>
        Tasa de interés anual:{" "}
        <Text style={styles.resultText}>{tasaInteres} %</Text>
      </Text>
      ...
      <LineChart
        data={{
          ...
          datasets: [
            {
              data: Array.from(
                { length: edadJubilacion - edadActual + 1 },
                (_, i) => montoActual * Math.pow(1 + tasaInteres / 100, i)
              ),
            },
          ],
        }}
