...
import TablaAmortCuota from "./Anexos/TablasAmortizacion/TablaAmortCuota";
import TablaAmortPlazo from "./Anexos/TablasAmortizacion/TablaAmortPlazo";

import CalculadoraHipotecaria from "./enlaces/CalculadoraHipoteca";
import ResultadoHipoteca from "./Anexos/ResultadoHipoteca";
import SimuladoresHipotecarios from "./enlaces/Simuladores Hipotecarios";
import CalculadoraCarencia from "./enlaces/CalculadoraCarencia";
import ResultadoCarencia from "./Anexos/ResultadoCarencia";
import CalculadoraAmortAnticipada from "./enlaces/CalculadoraAmortAnticipada";
import ResultadoAmortAnticipada from "./Anexos/ResultadoAmortAnticipada";
...
export function HerramientasStack() {
  return (
    <Stack.Navigator>
      ...
      />
      <Stack.Screen
        name="CalculadoraInmediata"
        component={CalculadoraRentaInmediata}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="ResultadoInmediatas"
        component={ResultadosRentaInmediata}
        options={{ headerShown: false }}
      />
      <Stack.Screen
      ...
      <Stack.Screen
        ...
        component={CalculadoraAmortAnticipada}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="ResultadoAmortAnticipada"
        component={ResultadoAmortAnticipada}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="TablaAmortCuota"
        component={TablaAmortCuota}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="TablaAmortPlazo"
        component={TablaAmortPlazo}
        options={{ headerShown: false }}
      />
    </Stack.Navigator>
  );
